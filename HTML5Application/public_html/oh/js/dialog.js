...
Much obliged, kitten!\n\
With these I can\n\
 build myself a house", "Sound": "HoboCatSound1", "Choice": false, "NextID": 3, "End": true, "Triggers": [{
            Stat: "built",
            Value: "hoboCatHouse"
          }, {Stat: "score", Value: -50}]
        }
      ...
      "dialog": [
        {
          ...
          "Choice": false, "NextID": 1, "Triggers": [{
            Stat: "built",
            Value: "hoboCatHouse"
          }, {Stat: "score", Value: -20}], "End": true
        }
      ], "idle": {
        "what": "homeowners association \n\
here I come!"}
    },
    "orphanageInsufficient":
    {
      "dialog": [
        {
...
gotta fend for themselves", "Sound": "HoboCatSound1", "Choice": false, "NextID": 5, "End": true
        ...
        {"Who": "Catz", "What": "meow!", "Sound": "catzSound1", "Choice": false, "NextID": 4, "Triggers": [{Stat: "built", Value: "orphanage"}, {Stat: "score", Value: -50}, {Stat: "kittensApprovalRating", Value: 0.001}, {Stat: "catPartyApprovalRating", Value: -0.0001}], "End": false},
        {
...
rocket rides, right kitten?", "Sound": "HoboCatSound1", "Choice": false, "NextID": 6, "End": true
    ...
    {
      "dialog": [{
        "Who": "Hobo-Cat", "What": "Let's make the catnip rehab center\n\
...
then...", "Choice": false, "NextID": 10, "End": true
    ...
    {
      "dialog": [{
        "Who": "Hobo-Cat", "What": "We should add better\n\
...
that fancy new garden"}
  ...
  "timmy": {
    ...
    "youthCenter":
    {
      "dialog": [{"Who": "Timmy", "What": "I can have youth center for stray kitties?", "Choice": true, "Choices": [{"text": "no", "ChoiceID": 1}, {"text": "yes", "ChoiceID": 3}], "NextID": 1, "End": false},
      {"Who": "Catz", "What": "meow...", "Choice": false, "NextID": 2, "End": false},
    ...
    "summerCamp":
    {
      "dialog": [{"Who": "Timmy", "What": "I can have summer camp for stray kitties?", "Choice": true, "Choices": [{"text": "no", "ChoiceID": 1}, {"text": "yes", "ChoiceID": 3}], "NextID": 1, "End": false},
      {"Who": "Catz", "What": "meow...", "Choice": false, "NextID": 2, "End": false},
      {"Who": "Timmy", "What": "oh no", "Choice": false, "NextID": 10, "End": true},
    ...
    "rocketUniversity":
    {
      ...
      {"Who": "Timmy", "What": "i'll enroll to the Catz Rocket Institute Rocketeer Program right away!", "Choice": false, "NextID": 10, "End": true}],
  ...
  "priest": {
    ...
    {
      "dialog": [{
        "Who": "Priest", "What": "I see you have a home for\n\
